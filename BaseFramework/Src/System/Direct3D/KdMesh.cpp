...
void KdMesh::SetToDevice() const
{
	...
	//プリミティブ・トポロジーをセット(D3D11_PRIMITIVE_TOPOLOGY_LINELIST)
	D3D.GetDevContext()->IASetPrimitiveTopology(D3D10_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
}
